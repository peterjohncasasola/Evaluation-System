    ...
    <card-component class="has-table has-mobile-sort-spaced" title="Students">
     ...
     >
      <template slot-scope="props">
       <b-table-column searchable label="Student ID" field="student_id">{{
       ...
       <b-table-column
        ...
        field="middle_name"
        sortable
        :title="props.row.middle_name"
        >{{ props.row.middle_name | isEmpty }}</b-table-column
       >
